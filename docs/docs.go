...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/appointments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Trường lọc (vd: status, userName)",
                        "name": "searchBy",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/categorydto.CreateCategoryResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/categorydto.UpdateCategoryResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/notificationdto.GetAllNotiResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/client/posts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "example": "authorName, title, createdAt, isFeatured",
                    ...
                    {
                        "type": "string",
                        "description": "Giá trị lọc (authorName, title, tag, content)",
                        "name": "search",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authdto.SignUpRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/authdto.SignUpResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/notificationdto.ReadAllNotiResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/notifications/fcm-token": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Store FCM token info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/notificationdto.StoreFCMTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/notificationdto.StoreFCMTokenResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Delete FCM token info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/notificationdto.DeleteFCMTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/notificationdto.DeleteFCMTokenResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/posts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort column (authorName title createdAt isFeatured)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "GiveAwayOldItem:1, FoundItem:2, SeekLoseItem:3, WantOldItem:4, Campaign:5, Other:6",
                        "name": "type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Trường lọc (title authorName isFeatured)",
                        "name": "searchBy",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/statisticdto.StatisticTransactionResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "appointmentdto.AppointmentDTO": {
            ...
            "properties": {
                "appointmentItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/appointmentdto.AppointmentItemDTO"
                    }
                },
                "createdAt": {
                    "type": "string"
        ...
        "appointmentdto.AppointmentItemDTO": {
            "type": "object",
            "properties": {
                "actualQuantity": {
                    "type": "integer"
        ...
        "appointmentdto.GetAppointmentResponse": {
            "type": "object",
            "properties": {
                "appointments": {
                    "type": "array",
        ...
        "appointmentdto.GetAppointmentResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/appointmentdto.GetAppointmentResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "categorydto.CreateCategoryResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "categorydto.UpdateCategoryResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "notificationdto.DeleteFCMTokenRequest": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string"
        ...
        "notificationdto.DeleteFCMTokenResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "notificationdto.GetAllNotiResponse": {
            "type": "object",
            "properties": {
                "notifications": {
                    "type": "array",
        ...
        "notificationdto.GetAllNotiResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/notificationdto.GetAllNotiResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "notificationdto.ReadAllNotiResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "notificationdto.StoreFCMTokenRequest": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string"
        ...
        "notificationdto.StoreFCMTokenResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "statisticdto.StatisticTransactionResponse": {
            "type": "object",
            "properties": {
                "totals": {
                    "type": "array",
        ...
        "statisticdto.StatisticTransactionResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/statisticdto.StatisticTransactionResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "warehousedto.RemoveClaimRequestResponseWrapper": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
