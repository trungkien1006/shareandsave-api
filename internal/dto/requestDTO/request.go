...
type CreateRequestSendOldItem struct {
	...
	RequestType         enums.RequestType `json:"requestType" binding:"required;oneof=SendOldItem SendLoseItem ReceiveOldItem"` // 1: Send Old Item, 2: Request Item, 3: Request Post, 4: Reply Post
